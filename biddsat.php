...
<td width="20%"
title="Temporal distribution of records. Each dot represents a unique date. Radius reflects year (center=1750, perimeter=now) and clockwise angle from vertical reflects day-of-year (0�=Jan-1, 359�=Dec-31). Color follows a cold-hot exponential scale, dark blue representing only 1 record and brown representing more than 2048 records."
