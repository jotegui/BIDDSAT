...
$filename=$path.'RecordsByResource.txt';
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        data.addColumn('string', 'Dataset ID');
...
?>
        ...
        chart.draw(data, {width: 750, height: 600, title: 'Records per dataset for publisher <?php echo $prov; ?>'});
		
		var tableData = new google.visualization.DataTable();
        tableData.addColumn('string', 'Dataset ID');
